...
3（P1111并查集黄 P3379LCA 黄 P3865ST表黄）
...
20.| 42  | **P1111** | 修复公路 | 并查集 |     |
21.| 49  | **P3379** | 最近公共祖先（LCA） | LCA/RMQ | 倍增法、欧拉序+ST表、Tarjan |
22.| 50  | **P3865** | ST 表 && RMQ 问题 | RMQ | ST 表 |
...
### C随堂检查
进度好，编程规范；思路清晰，回答问题严谨正确 90-100
进度好，编程较规范；思路清晰，回答问题正确但有不严谨之处 75-89
### D实验报告
报告撰写认真，文字描述准确，排版整齐
对相关算法认识全面，设计思路清晰，技术选择得当，算法设计正确，创新性好90-100
## 总分
